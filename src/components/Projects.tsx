...
const Projects = () => {
  ...
  return (
    <section id="projects" ref={sectionRef} className="py-20 bg-gray-800/30 dark:bg-gray-800/30">
      <div className="container mx-auto px-4">
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          {/* Featured Projects */}
          <div className="mb-20">
            <h3 className="text-2xl font-bold mb-8 text-center flex items-center justify-center text-white dark:text-white">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              {featuredProjects.map((project, index) => (
                <div
                  key={project.id}
                  className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900/80 to-gray-800/80 hover:from-gray-800/80 hover:to-gray-700/80 transition-all duration-500 transform hover:scale-105 border border-gray-700 hover:border-cyber-green/50 shadow-xl hover:shadow-2xl dark:from-gray-900/80 dark:to-gray-800/80 dark:hover:from-gray-800/80 dark:hover:to-gray-700/80 dark:border-gray-700 dark:hover:border-cyber-green/50"
                ...
                >
                  ...
                  <div className="p-6">
                    <h4 className="text-xl font-bold mb-3 text-white dark:text-white group-hover:text-green-400 transition-colors line-clamp-2">
                      {project.title}
                    </h4>
                    
                    <div className="mb-4">
                      <p className="text-sm text-gray-400 dark:text-gray-400 mb-2 font-inter">
                        <strong className="text-blue-400">Contexte:</strong> {project.context}
                      </p>
                      <p className="text-sm text-gray-400 dark:text-gray-400 font-inter">
                        <strong className="text-green-400">Rôle:</strong> {project.role}
                      </p>
                    </div>

                    <p className="text-gray-300 dark:text-gray-300 mb-4 line-clamp-3 font-inter">
                      {project.description}
                    </p>

                    {/* Key Features */}
                    <div className="grid grid-cols-3 gap-2 mb-4">
                      <div className="text-center p-2 bg-gray-800/50 dark:bg-gray-800/50 rounded-lg">
                        <Shield size={16} className="text-red-400 mx-auto mb-1" />
                        <span className="text-xs text-gray-300 dark:text-gray-300">Sécurité</span>
                      </div>
                      <div className="text-center p-2 bg-gray-800/50 dark:bg-gray-800/50 rounded-lg">
                        <Palette size={16} className="text-purple-400 mx-auto mb-1" />
                        <span className="text-xs text-gray-300 dark:text-gray-300">Design</span>
                      </div>
                      <div className="text-center p-2 bg-gray-800/50 dark:bg-gray-800/50 rounded-lg">
                        <FileText size={16} className="text-blue-400 mx-auto mb-1" />
                        <span className="text-xs text-gray-300 dark:text-gray-300">Docs</span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.technologies.slice(0, 4).map((tech) => (
                        <span
                          key={tech}
                          className="px-2 py-1 bg-gray-800 dark:bg-gray-800 text-gray-300 dark:text-gray-300 text-xs rounded-full border border-gray-600 dark:border-gray-600"
                        >
                          {tech}
                        </span>
                      ))}
                      {project.technologies.length > 4 && (
                        <span className="px-2 py-1 bg-gray-800 dark:bg-gray-800 text-gray-400 dark:text-gray-400 text-xs rounded-full border border-gray-600 dark:border-gray-600">
                          +{project.technologies.length - 4}
                        </span>
                      )}
                    </div>
            ...
            <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
              ...
              <div className="relative w-full lg:w-96">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-gray-800/50 dark:bg-gray-800/50 border border-gray-700 dark:border-gray-700 rounded-xl text-white dark:text-white placeholder-gray-400 dark:placeholder-gray-400 focus:border-green-400 focus:outline-none transition-colors"
                />
              </div>

              {/* Filters */}
              <div className="flex flex-wrap gap-2 items-center">
                <Filter className="text-gray-400 dark:text-gray-400 mr-2" size={20} />
                  ...
                  <button
                    ...
                    className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-inter font-medium transition-all duration-300 ${
                      activeFilter === category.id
                        ...
                        : 'bg-gray-800/50 dark:bg-gray-800/50 text-gray-300 dark:text-gray-300 hover:bg-gray-700/50 dark:hover:bg-gray-700/50 border border-gray-700 dark:border-gray-700'
                    }`}
                  >
                    {category.icon}
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            {filteredProjects.map((project, index) => (
              <div
                key={project.id}
                className="group relative overflow-hidden rounded-xl bg-gray-900/50 dark:bg-gray-900/50 hover:bg-gray-800/50 dark:hover:bg-gray-800/50 transition-all duration-300 transform hover:scale-105 border border-gray-700 dark:border-gray-700 hover:border-gray-600 dark:hover:border-gray-600 shadow-lg hover:shadow-xl"
              ...
              >
                ...
                <div className="p-6">
                  <h4 className="text-lg font-bold mb-2 text-white dark:text-white group-hover:text-green-400 transition-colors line-clamp-2">
                    {project.title}
                  </h4>
                  ...
                  <p className="text-gray-300 dark:text-gray-300 mb-4 text-sm line-clamp-2">
                    {project.description}
                  </p>
                  ...
                  <div className="mb-4">
                    <div className="grid grid-cols-3 gap-2 text-xs">
                      <div className="bg-red-500/20 border border-red-500/30 rounded-lg p-2 text-center">
                        ...
                        <div className="text-gray-400 dark:text-gray-400">{project.features.security.length} points</div>
                      </div>
                      <div className="bg-purple-500/20 border border-purple-500/30 rounded-lg p-2 text-center">
                        ...
                        <div className="text-gray-400 dark:text-gray-400">{project.features.design.length} aspects</div>
                      </div>
                      <div className="bg-blue-500/20 border border-blue-500/30 rounded-lg p-2 text-center">
                        ...
                        <div className="text-gray-400 dark:text-gray-400">{project.features.documentation.length} types</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-1 mb-4">
                    {project.technologies.slice(0, 3).map((tech) => (
                      <span
                        key={tech}
                        className="px-2 py-1 bg-gray-800 dark:bg-gray-800 text-gray-300 dark:text-gray-300 text-xs rounded-full"
                      >
                        {tech}
                      </span>
                    ))}
                    {project.technologies.length > 3 && (
                      <span className="px-2 py-1 bg-gray-800 dark:bg-gray-800 text-gray-400 dark:text-gray-400 text-xs rounded-full">
                        +{project.technologies.length - 3}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="flex space-x-4">
                    <a
                      href={project.github}
                      className="flex items-center space-x-1 text-gray-400 dark:text-gray-400 hover:text-white dark:hover:text-white transition-colors text-sm"
                    >
                      <Github size={14} />
                      <span>Code</span>
                    </a>
          ...
          {filteredProjects.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-400 dark:text-gray-400 text-lg">Aucun projet trouvé pour ces critères.</p>
            </div>
          )}
