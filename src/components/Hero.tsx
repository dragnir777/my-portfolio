...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      {/* Animated Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-deep-night via-blue-900 to-deep-night dark:from-deep-night dark:via-blue-900 dark:to-deep-night">
        ...
        <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="relative inline-block mb-8">
            <div className="w-52 h-52 mx-auto rounded-full bg-gradient-to-br from-green-400 to-blue-500 p-1 shadow-2xl">
              <div className="w-full h-full rounded-full bg-gray-800 dark:bg-gray-800 flex items-center justify-center">
                <img
          ...
          <h1 className="text-5xl md:text-7xl font-poppins font-bold mb-6">
            <span className="block text-off-white dark:text-off-white">Axison</span>
            <span className="block bg-gradient-to-r from-cyber-green to-blue-500 bg-clip-text text-transparent">
              BAYALA
            </span>
          </h1>

          <p className="text-xl md:text-2xl text-gray-300 dark:text-gray-300 mb-4 max-w-3xl mx-auto font-inter font-medium">
            Développeur Web Full Stack Burkinabè
          </p>
          
          <p className="text-lg text-gray-400 dark:text-gray-400 mb-8 max-w-2xl mx-auto font-inter leading-relaxed">
          ...
          <div className="flex items-center justify-center space-x-6 mb-12">
            <a href="#" className="p-4 bg-gray-800 dark:bg-gray-800 hover:bg-gray-700 dark:hover:bg-gray-700 rounded-full transition-all duration-300 hover:scale-110 transform shadow-lg">
              <Github size={24} className="text-white dark:text-white" />
            </a>
            <a href="#" className="p-4 bg-gray-800 dark:bg-gray-800 hover:bg-gray-700 dark:hover:bg-gray-700 rounded-full transition-all duration-300 hover:scale-110 transform shadow-lg">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
        <div className="w-6 h-10 border-2 border-gray-400 dark:border-gray-400 rounded-full p-1">
