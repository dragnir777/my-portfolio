    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-content mx-auto px-6 relative z-10">
        <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="relative inline-block mb-8">
            <div className="w-52 h-52 mx-auto rounded-full bg-gradient-to-br from-cyber-green to-blue-500 p-1 animate-spin-slow shadow-2xl">
            ...
            <div className="absolute -bottom-2 -right-2 w-14 h-14 bg-cyber-green rounded-full flex items-center justify-center animate-bounce shadow-lg">
          ...
          <p className={`text-lg ${isDarkMode ? 'text-gray-400' : 'text-gray-500'} mb-8 max-w-2xl mx-auto font-inter leading-relaxed`}>
            Spécialisé en <strong className="text-cyber-green">sécurité</strong>, <strong className="text-blue-400">design UI/UX</strong> et 
          ...
          <div className="flex items-center justify-center space-x-6 mb-12">
            ...
            <a href="#" className={`p-4 ${isDarkMode ? 'bg-gray-800 hover:bg-gray-700' : 'bg-gray-200 hover:bg-gray-300'} rounded-full transition-all duration-300 hover:scale-110 transform shadow-lg`}>
              <MessageCircle size={24} className="text-cyber-green" />
            </a>
          </div>
          ...
          <button
            ...
            className="inline-flex items-center px-10 py-5 bg-gradient-to-r from-cyber-green to-blue-500 hover:from-green-600 hover:to-blue-600 rounded-full text-white font-poppins font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg"
          >
            Voir mes projets
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
        <div className={`w-6 h-10 border-2 ${isDarkMode ? 'border-gray-400' : 'border-gray-600'} rounded-full p-1`}>
          <div className="w-1 h-3 bg-cyber-green rounded-full animate-bounce mx-auto" />
        </div>
      </div>
    </section>
  );
